...
const columnasFilas=document.getElementById("columnasFilas");
const URLproductos = "https://api.escuelajs.co/api/v1/products";

btnLoadProducts.addEventListener("click",function(event){
    event.preventDefault();
    console.log("hola");
     const options={"method": "GET"};
     fetch(URLproductos,options)
    .then((response)=>{
...
function crearCards(productos){
    productos.forEach(elemento => {
        columnasFilas.insertAdjacentHTML("beforeend",
            `<div class="col">
